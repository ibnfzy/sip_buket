...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <form action="<?= base_url('AdminPanel/Produk'); ?>" method="post" enctype="multipart/form-data">
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <input type="number" name="stok_produk" id="stok_produk" class="form-control" placeholder="" value="1">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="exampleInputEmail1">Gambar Produk <span class="text-red">* Max FILESIZE <= 2mb </span></label>
            <?= form_input('gambar', '', [
              'class' => 'form-control',
              'accept' => 'image/*'
            ], 'file'); ?>
