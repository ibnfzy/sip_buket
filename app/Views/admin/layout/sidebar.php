<aside class="main-sidebar elevation-4 sidebar-light-pink">
  <!-- Brand Logo -->
  <a href="<?= base_url('AdminPanel'); ?>" class="brand-link">
  ...
  <div
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item mb-2">
          <a href="<?= base_url('AdminPanel/TransaksiBelumSelesai'); ?>"
            class="nav-link <?= $retVal = (url_is('AdminPanel/TransaksiBelumSelesai')) ? 'active' : ''  ?>">
